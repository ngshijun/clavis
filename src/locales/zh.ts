export default {
  ...
  hero: {
    ...
    titleHighlight: '游戏',
    description:
      'Clavis 帮助小学生通过游戏化练习、可收集的宠物和实时进度追踪来掌握学业。家长随时掌握孩子的学习动态。',
    getStarted: '免费开始',
    haveAccount: '我已有账号',
    stats: {
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          '作为上班族家长，我们不一定每天都有时间指导女儿。Clavis 帮助她每天做一点练习。报告清楚地显示她哪些课题比较弱，所以考试前的复习变得容易多了。',
        name: 'Mdm Chuah T. T.',
        role: '家长',
        initials: 'CT',
      },
      {
        quote:
          '进度报告对家长非常有帮助。我可以清楚地看到儿子哪些课题需要更多练习，让考试复习更轻松，也帮我们省了很多时间。考虑到功能和每日练习，Clavis 的性价比也很高。',
        name: 'Mr. Lim C. E.',
        role: '家长',
        initials: 'LC',
      },
      {
        quote:
          '我的儿子比较好胜，所以他很喜欢收集宠物和奖励。没想到这激励他几乎每天都主动在 Clavis 上练习，不需要我们提醒。学习和乐趣之间取得了很好的平衡。',
        name: 'Mrs. Wong M. L.',
        role: '家长',
        initials: 'WM',
      },
      ...
      // {
      //   quote:
      //     '我儿子以前很怕做数学功课。用了 Clavis 三个星期后，他的月考从65分进步到82分——现在他主动要求练习，因为他想进化他的宠物！',
      //   name: 'Sarah L.',
      //   role: '三年级学生家长',
      //   initials: 'SL',
      // },
      // {
      //   quote:
      //     '我喜欢题目的风格跟学校考试一样。我每天放学后做2到3次练习，只需要10分钟。这学期我的科学成绩进步了很多！',
      //   name: 'Ahmad K.',
      //   role: '五年级学生',
      //   initials: 'AK',
      // },
      // {
      //   quote:
      //     '我有两个孩子，分别读二年级和四年级。能清楚看到他们在哪些课题遇到困难，帮我省了很多时间——我知道该帮他们复习什么。',
      //   name: 'Michelle T.',
      //   role: '两名华小学生家长',
      //   initials: 'MT',
      // },
