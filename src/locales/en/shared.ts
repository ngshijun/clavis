export default {
  ...
  errors: {
    ...
    noQuestionsAvailable: 'No questions available for this stage.',
    ...
    failedFetchStageStats: 'Failed to load your learning progress.',
    // Curriculum (admin)
    ...
    failedReorderStages: 'Failed to save the learning path order.',
    ...
    failedReorderSubTopics: 'Failed to save the sub-topic order.',
    ...
    failedRegenerateQuestion: 'Failed to swap the question.',
    ...
    failedFetchPapers: 'Failed to load papers.',
    failedCreatePaper: 'Failed to create the paper.',
    failedUpdatePaper: 'Failed to update the paper.',
    failedDeletePaper: 'Failed to delete the paper.',
    failedAdoptPaper: 'Failed to adopt the paper.',
    ...
    regenerateNotGenerated: 'This question was not generated, so there is nothing to swap it for.',
  ...
  statsSummaryCards: {
    ...
    stagesPracticed: 'Stages Practiced',
  },
  editAvatarDialog: {
  ...
  questionBank: {
    ...
    subtitle:
      'Every exam question lives here, filed under a sub-topic. Papers point at these questions, so an edit here reaches every paper that holds it.',
    centerTitle: 'Our Question Bank',
    centerSubtitle:
      "Your center's own exam questions, filed under a sub-topic. They are yours alone — no other center sees them — and your generated assessments draw from them alongside the platform's.",
    addBtn: 'Add question',
    ...
    manageSubTopics: 'Manage sub-topics',
    manageSubTopicsTitle: 'Sub-topics',
    manageSubTopicsDesc:
      'Bank questions of this topic are filed under these sub-topics, and a generation line draws from them.',
    addSubTopic: 'Add Sub-Topic',
    noSubTopics: 'No sub-topics yet',
    noSubTopicsDesc: (topic: string) => `Add the first sub-topic to ${topic}.`,
  ...
  tagMultiSelect: {
    ...
    noTopicContext: 'Choose a topic first — learning points are scoped to one.',
  },
  ...
  questionBulkUploadDialog: {
    ...
    scopedNotice: (stage: string) => `All imported questions will be added to "${stage}".`,
