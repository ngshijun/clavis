export default {
  ...
  errors: {
    ...
    stageNotFound: '未找到此阶段。',
    noQuestionsAvailable: '此阶段暂无题目。',
    ...
    failedFetchStageStats: '加载学习进度失败。',
    // Curriculum (admin)
    ...
    failedAddStage: '添加阶段失败。',
    failedUpdateStage: '更新阶段失败。',
    failedDeleteStage: '删除阶段失败。',
    failedReorderStages: '保存学习路径顺序失败。',
    failedAddSubTopic: '添加子课题失败。',
    failedUpdateSubTopic: '更新子课题失败。',
    failedDeleteSubTopic: '删除子课题失败。',
    failedReorderSubTopics: '保存子课题顺序失败。',
    ...
    failedRegenerateQuestion: '更换题目失败。',
    failedFetchAssignments: '加载分配记录失败。',
    failedCreateAssignment: '分配测评失败。',
    failedRemoveAssignment: '移除分配失败。',
    failedFetchPapers: '加载试卷失败。',
    failedCreatePaper: '创建试卷失败。',
    failedUpdatePaper: '更新试卷失败。',
    failedDeletePaper: '删除试卷失败。',
    failedAdoptPaper: '采用试卷失败。',
    ...
    regenerateExhausted: '题库中没有其他符合条件的题目。',
    regenerateNotGenerated: '该题目不是生成的，无法更换。',
  ...
  questionBank: {
    title: '测验题库',
    subtitle:
      '所有考试题目都在这里，按子主题归档。试卷引用这些题目，因此在此处的修改会同步到所有引用它的试卷。',
    centerTitle: '本中心题库',
    centerSubtitle:
      '本中心自己的考试题目，按子主题归档。仅本中心可见，生成测评时会与平台题目一并抽取。',
    addBtn: '添加题目',
    gradeLabel: '年级',
    subjectLabel: '科目',
    topicLabel: '主题',
    ...
    allTopics: '所有主题',
    allSubTopics: '所有子主题',
    manageSubTopics: '管理子主题',
    manageSubTopicsTitle: '子主题',
    manageSubTopicsDesc: '本课题的题库题目按这些子主题归档，生成试卷时也从中抽取。',
    addSubTopic: '添加子主题',
    noSubTopics: '暂无子主题',
    noSubTopicsDesc: (topic: string) => `为「${topic}」添加第一个子主题。`,
    subTopicCount: (n: number) => `${n} 个子主题`,
    done: '完成',
    difficultyLabel: '难度',
  ...
  tagMultiSelect: {
    ...
    noTopicContext: '请先选择课题——学习点按课题划分。',
  },
  ...
  questionBulkUploadDialog: {
    ...
    scopedNotice: (stage: string) => `导入的所有题目都会添加到「${stage}」。`,
