...
import { Loader2, Trophy, Flame, Mail, CalendarHeart, GraduationCap } from 'lucide-vue-next'
...
const childLevel = computed(() => computeLevel(profile.value?.xp ?? 0))

watch([open, () => props.child?.id], ([isOpen, childId]) => {
  if (isOpen && childId) {
      ...
      <template v-if="child">
        ...
        <div v-else class="space-y-4">
          ...
          <div class="grid grid-cols-3 grid-rows-2 gap-4">
            ...
            <ProfilePetCard :pet="pet" :no-pet-label="t.shared.childProfileDialog.noPetSelected" />
            ...
            >
              ...
              <BestSubjectsList
                ...
                :empty-label="t.shared.childProfileDialog.notYetUnlocked"
              />
            </div>
            ...
            >
              ...
              <WeeklyActivityStrip
                ...
                :days-label="t.shared.childProfileDialog.days"
              />
            </div>
          </div>
