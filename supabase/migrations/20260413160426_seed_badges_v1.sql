...
-- Presentation order is owned by migration 20260518000000 (display_order column + backfill).
-- ============================================================================
...
values
  ...
  -- evolved is reshaped from Gold to Bronze in v2 (migration 20260420120000).
